          ...
          <ol >
            ...
            <li><i class="pregs">¿Cómo hago para modificar mis datos?</i></li><br>
                ...
                Cualquier duda/consulta, recordá que podés comunicarte con nuestros asesores al 0800-123-12312 opción 2 de Lunes a viernes de 8:30 a 22:00 horas.  </p><br>

            <li><i class="pregs">¿Como me registro?</i></li><br>
                <p>Podrás crear tu cuenta en el siguiente link: <a href="login.php">Registrate </a>donde debés completar todos los datos solicitados.</p><br>
            ...
            <li><i class="pregs">¿Como realizo mi compra?</i></li><br>
                ...
                Luego seleccioná la opción <a href="productos.php">COMPRA ONLINE </a> para poder navegar en nuestro catálogo de productos y realizar tus compras de manera rápida, fácil y simple.</p><br>

            <li><i class="pregs">¿Puedo anular una compra?</i></li><br>
                <p>Para anular tu pedido es necesario que te comuniques con nosotros al 0800-123-12312 opción 2 así podemos asistirte.</p><br>

            <li><i class="pregs">¿Cuales son los medios de pago disponibles?</i></li><br>
                <p>Podés abonar tu pedido con una amplia cantidad de Tarjetas de Crédito. <br><img class="tarjetas" src="images/creditcards.jpg" alt="tarjetas de credito"><br> Deben estar emitidas dentro de la Republica Argentina. </p><br>

            <li><i class="pregs">Me olvide mi contraseña... ¿Que hago?</i></li><br>
                <p>  Si no recordás tu contraseña podés hacer clik en el enlace <a href="login.php">"Cuenta"</a> - "Olvidé mi contraseña" ubicado en la parte inferior de la página principal. En la nueva página te pedirá escribir tu dirección de e-mail con la cual te registraste. Después de haber confirmado tus datos, recibirás un e-mail en tu correo en el cual te permitira elegir una nueva contraseña. </p><br>
